...
psql -d dashboard -c "CREATE INDEX siret_siret ON siret (siret);"
echo "Creating index on siren column"
psql -d dashboard -c "CREATE INDEX siret_siren ON siret (siren);"
echo "Creating index on codeCommuneEtablissementString column"
psql -d dashboard -c "CREATE INDEX siret_codeCommuneEtablissement ON siret (codeCommuneEtablissement);"
echo "Creating index on reg column"
psql -d dashboard -c "CREATE INDEX siret_reg ON siret (reg);"
echo "Creating index on dep column"
psql -d dashboard -c "CREATE INDEX siret_dep ON siret (dep);"
echo "Creating index on arr column"
psql -d dashboard -c "CREATE INDEX siret_arr ON siret (arr);"
echo "index created"
