...
read_file = pd.read_csv ("../published-data/fonds-solidarite-volet-2-regional-naf-latest.csv",dtype=str)
read_file.to_excel ('../published-data/fonds-solidarite-volet-2-regional-naf.xlsx', index = None, header=True)
...
read_file = pd.read_csv ("../published-data/fonds-solidarite-volet-2-regional-categorie-juridique-latest.csv",dtype=str)
read_file.to_excel ('../published-data/fonds-solidarite-volet-2-regional-categorie-juridique-latest.xlsx', index = None, header=True)
...
read_file = pd.read_csv ("../published-data/fonds-solidarite-volet-2-regional-classe-effectif-latest.csv",dtype=str)
read_file.to_excel ('../published-data/fonds-solidarite-volet-2-regional-classe-effectif-latest.xlsx', index = None, header=True)
