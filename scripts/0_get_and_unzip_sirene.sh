for d in `seq -w 1 19` 2A 2B `seq 21 74` `seq 76 95` 98 ""; do
  wget http://data.cquest.org/geo_sirene/v2019/last/dep/geo_siret_$d.csv.gz
...
for d in {01..20}; do
  wget http://data.cquest.org/geo_sirene/v2019/last/dep/geo_siret_751$d.csv.gz
...
for d in `seq -w 1 8`; do
  wget http://data.cquest.org/geo_sirene/v2019/last/dep/geo_siret_97$d.csv.gz
